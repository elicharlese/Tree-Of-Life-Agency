      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <div className="card-organic p-6 text-center">
            <div className="w-12 h-12 bg-leaf-100  flex items-center justify-center mx-auto mb-3">
          ...
          <div className="card-organic p-6 text-center">
            <div className="w-12 h-12 bg-yellow-100  flex items-center justify-center mx-auto mb-3">
          ...
          <div className="card-organic p-6 text-center">
            <div className="w-12 h-12 bg-wisdom-100  flex items-center justify-center mx-auto mb-3">
        ...
        <div className="space-y-6">
          {filteredOrders.length === 0 ? (
            <div className="card-organic p-12 text-center">
              <div className="w-16 h-16 bg-bark-100  flex items-center justify-center mx-auto mb-4">
