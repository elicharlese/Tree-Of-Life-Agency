...
import { getOrders, developers, Order, createOrder, updateOrder, services, calculateOrderTotal, estimateTimeline } from '../../libs/shared-utils/orders'
    ...
    if (allOrders.length === 0) {
      const sampleOrders: Order[] = [
          ...
          items: [
            {
              ...
              price: 20000,
              timeline: '8-10 weeks',
              features: ['React Native', 'Push Notifications']
            }
          ],
          total: 20000,
          totalAmount: 20000,
        ...
        },
        {
          ...
          customerEmail: 'michael@enterprise.com',
          companyName: 'Enterprise Solutions',
          projectName: 'Dashboard Redesign',
          description: 'Complete UI/UX redesign of admin dashboard',
          items: [
            {
              id: 'item-4',
              serviceId: 'design',
              ...
              price: 8000,
              timeline: '3-4 weeks',
              features: ['Wireframing', 'Prototyping', 'Design System']
            }
          ],
          total: 8000,
          totalAmount: 8000,
    ...
    <div className="min-h-screen bg-dark-900 text-white">
      ...
      <div className="bg-dark-800 border-b border-dark-700">
        <div className="max-w-full px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2 bg-dark-700  px-3 py-2">
                <span className="text-sm text-gray-300">Total Hours:</span>
                <span className="text-white font-bold">1134</span>
              </div>
              <div className="flex items-center space-x-2 bg-green-600  px-3 py-2">
      ...
      <div className="flex h-screen">
        ...
        <div className="w-80 bg-dark-800 border-r border-dark-700 p-6">
          ...
          {/* Cost Analysis Chart */}
          <div className="bg-dark-700  p-4 mb-6">
            ...
            <div className="space-y-2">
              ...
              <div className="w-full bg-dark-600  h-2">
              ...
              <div className="w-full bg-dark-600  h-2">
                <div className="bg-yellow-500 h-2 " style={{ width: '15%' }}></div>
              </div>
            </div>
          ...
          <div className="bg-dark-800  p-6 h-full">
                ...
                {selectedOrder ? (
                  <div className="grid grid-cols-2 gap-8">
                    ...
                    <div>
                      ...
                      <div className="bg-dark-700  p-4 h-64 flex items-center justify-center">
            ...
            {selectedView === 'sow' && (
              <div>
                ...
                {selectedOrder ? (
                  <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/20  p-8 text-center">
            ...
            {selectedView === 'roadmap' && (
              <div>
                ...
                {selectedOrder ? (
                  <div className="bg-gradient-to-br from-green-900/20 to-teal-900/20  p-8 text-center">
                    ...
                    <button className="bg-green-600 text-white px-8 py-3  font-medium hover:bg-green-700">
                      Unlock Roadmap
                    </button>
                  </div>
                ) : (
            ...
            {selectedView === 'code' && (
              <div>
                ...
                {selectedOrder ? (
                  <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20  p-8 text-center">
                    ...
                    <button className="bg-purple-600 text-white px-8 py-3  font-medium hover:bg-purple-700">
        ...
        <div className="w-80 bg-dark-800 border-l border-dark-700 p-6">
          <div className="mb-6">
            ...
            <div className="bg-dark-700  p-4 mb-4">
          ...
          <div className="space-y-4">
            {developers.slice(0, 3).map((developer) => (
              <div key={developer.id} className="bg-dark-700  p-4">
